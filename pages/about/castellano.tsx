    ...
    return (
            <div className='contentBody'>
                <div className='aboutWrapperBtn'>
                    <div onClick={() => Router.push('/about/')} className='btnYellow'>About English</div>
                </div>
                <div className='aboutTxt'>
                    ...
                    Una identidad digital en la Red TYRON está compuesta por contratos inteligentes, que son propiedad del usuarie, y conforman una identidad autosoberana *(o SSI: self-sovereign identity*); o sea, es una cuenta de usuarie diseñada con tecnologías descentralizadas, para darte un total control sobre tus datos y finanzas. Incluye una <a href='https://www.notion.so/f4c6ecd8c367476f8db15f33784c24d3'>billetera digital</a> y una identidad descentralizada, y tiene un Nombre de Usuarie *NFT* (Non-Fungible Token o en castellano: ****token no fungible) que la identifica en la Red TYRON. De este modo, el nombre *NFT* permite las funcionalidades de Recuperación Social **y Credenciales Verificables, lo que mejora la seguridad y experiencia en línea.
