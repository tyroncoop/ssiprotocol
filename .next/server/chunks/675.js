...
exports.ids = [675]
exports.modules = {
    /***/ 273: /***/ (__unused_webpack_module, exports) => {
        'use strict'
    ...
    /***/ 749: /***/ (module, exports, __webpack_require__) => {
        'use strict'
        ...
        var _interop_require_default =
            __webpack_require__(648) /* ["default"] */.Z
        var _interop_require_wildcard =
            __webpack_require__(598) /* ["default"] */.Z
        var _object_without_properties_loose =
            __webpack_require__(273) /* ["default"] */.Z
        ...
        const Image = /*#__PURE__*/ (0, _react).forwardRef(
            (_param, forwardedRef) => {
                ...
                if ('__next_img_default' in loader) {
                    ...
                    ;(_tmp = (obj) => {
                        const { config: _ } = obj,
                            opts = _object_without_properties_loose(obj, [
                                'config',
                            ])
                ...
                if (isStaticImport(src)) {
                    const staticImageData = isStaticRequire(src)
                        ? src.default
                        : src
                    ...
                    if (!fill) {
                        if (!widthInt && !heightInt) {
                            ...
                            heightInt = Math.round(
                                staticImageData.height * ratio
                            )
                        } else if (!widthInt && heightInt) {
                            const ratio1 = heightInt / staticImageData.height
                            widthInt = Math.round(
                                staticImageData.width * ratio1
                            )
                        }
                    }
                }
